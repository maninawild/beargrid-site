...
- Canonical reference: `/knowledge#methodology`.
...
- Hub: `/knowledge`
- Future article: `/knowledge/{descriptive-slug}`
...
2. Every article links to one Knowledge Hub definition using exact or close-match terminology.
...
7. No article should be more than three internal clicks from `/knowledge`.
