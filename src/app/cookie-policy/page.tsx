...
export default function CookiePolicyPage() {
  return (
    <main className="policy-page">
      ...
      <section><h2>More information</h2><p>See our <Link href="/privacy-policy">Privacy Policy</Link> or submit a question through the <Link href="/contact">contact page</Link>.</p></section>
