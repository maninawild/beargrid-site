  ...
  return (
    <header className="company-header">
      <div className="company-header-inner">
        <Link className="company-brand" href={locale === "nl" ? "/nl" : "/"}><Image src="/logos/bear-grid-logo.png" alt="" width={52} height={46} priority /><span>BEAR GRID</span></Link>
...
export function SiteShell({ children }: { children: React.ReactNode }) {
  ...
  if (modernPaths.has(basePath)) return <><ModernHeader locale={locale} /><div className="flex-1">{children}</div><ModernFooter locale={locale} /><CookieConsent locale={locale} /><WhatsAppButton locale={locale} /></>;
